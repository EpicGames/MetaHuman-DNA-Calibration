...
def adjust_aim_control():
    ...
    """
    if not (
        cmds_exists("FACIAL_C_FacialRoot")
        and cmds_exists("FACIAL_L_Eye")
        and cmds_exists("FACIAL_R_Eye")
    ):
        return
    ...
    root_orientation = cmds_xform(
        "LOC_C_eyeDriver", query=True, worldSpace=True, rotation=True
    )
...
def connect_expressions():
    ...
    connect_expression("CTRL_L_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardUL", 0.0, 1.0)
    connect_expression("CTRL_R_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardUR", 0.0, 1.0)
    connect_expression("CTRL_L_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardDL", 0.0, 1.0)
    connect_expression("CTRL_R_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions",
                      "mouthLipsThinInwardDR", 0.0, 1.0)
    connect_expression("CTRL_L_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions",
                      "mouthLipsThickInwardUL", 0.0, 1.0)
    connect_expression("CTRL_R_mouth_thicknessInwardU", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions",
                      "mouthLipsThickInwardUR", 0.0, 1.0)
    connect_expression("CTRL_L_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions",
                      "mouthLipsThickInwardDL", 0.0, 1.0)
    connect_expression("CTRL_R_mouth_thicknessInwardD", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions",
                      "mouthLipsThickInwardDR", 0.0, 1.0)
    # corner sharpen
    ...
    connect_expression("CTRL_C_tongue_move", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueUp", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_move", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueDown", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_move", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueLeft", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_move", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueRight", 0.0, 1.0)
    # tongue in/out
    ...
    connect_expression("CTRL_C_tongue_bendTwist", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueBendUp", 0.0,
                      1.0)
    connect_expression("CTRL_C_tongue_bendTwist", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueBendDown", 0.0,
                      1.0)
    connect_expression("CTRL_C_tongue_bendTwist", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTwistLeft", 0.0,
                      1.0)
    connect_expression("CTRL_C_tongue_bendTwist", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTwistRight",
                      0.0, 1.0)
    # tongue tip move up/down/left/right
    connect_expression("CTRL_C_tongue_tipMove", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTipUp", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_tipMove", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTipDown", 0.0,
                      1.0)
    connect_expression("CTRL_C_tongue_tipMove", "tx", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueTipLeft", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_tipMove", "tx", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueTipRight", 0.0,
                      1.0)
    # tongue wide/narrow
    connect_expression("CTRL_C_tongue_wideNarrow", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueWide", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_wideNarrow", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueNarrow", 0.0,
                      1.0)
    # tongue press
    connect_expression("CTRL_C_tongue_press", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tonguePress", 0.0, 1.0)
    # tongue roll
    connect_expression("CTRL_C_tongue_roll", "ty", 0.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueRoll", 0.0, 1.0)
    # tongue thick/thin
    connect_expression("CTRL_C_tongue_thickThin", "ty", -1.0, 1.0, 0.0, 1.0, "CTRL_expressions", "tongueThick", 0.0, 1.0)
    connect_expression("CTRL_C_tongue_thickThin", "ty", -1.0, 1.0, 0.0, -1.0, "CTRL_expressions", "tongueThin", 0.0, 1.0)
    # jaw open
...
def clean_up(head_group, head_rig_group):
    ...
    if both_guis_loaded() and cmds_exists("headGui_grp"):
        ...
        if cmds_exists("FACIAL_C_FacialRoot"):
            cmds_parent_constraint(
                ["FACIAL_C_FacialRoot", "LOC_C_eyeDriver"], maintainOffset=True
            )
        cmds_delete("gui")
    ...
    if gui_loaded():
        ...
        cmds_set_attr(
            "CTRL_expressions.visibility", lock=True, keyable=False, channelBox=False
        )
...
def connect_neck_correctives():
    ...
    cmds_connect_attr("head.matrix", "head_RBFdecomposeMatrix.inputMatrix")
    cmds_connect_attr("neck_02.matrix", "neck_02_RBFdecomposeMatrix.inputMatrix")
    cmds_connect_attr("neck_01.matrix", "neck_01_RBFdecomposeMatrix.inputMatrix")

    # connect joints rotations (without JO) with setup
    cmds_connect_attr("head.rx", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")
    cmds_connect_attr("head.ry", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")
    cmds_connect_attr("head.rz", "head_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")
    cmds_connect_attr("neck_02.rx", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")
    cmds_connect_attr("neck_02.ry", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")
    cmds_connect_attr("neck_02.rz", "neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")
    cmds_connect_attr("neck_01.rx", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dx")
    cmds_connect_attr("neck_01.ry", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dy")
    cmds_connect_attr("neck_01.rz", "neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[0].input3Dz")

    # updating values for zero outing
    head_tx = cmds_get_attr("head.tx")
    cmds_set_attr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", head_tx)
    head_ty = cmds_get_attr("head.ty")
    cmds_set_attr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", head_ty)
    head_tz = cmds_get_attr("head.tz")
    cmds_set_attr("head_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", head_tz)
    head_rx = cmds_get_attr("head.rx")
    cmds_set_attr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", head_rx)
    head_ry = cmds_get_attr("head.ry")
    cmds_set_attr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", head_ry)
    head_rz = cmds_get_attr("head.rz")
    cmds_set_attr("head_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", head_rz)
    neck_02_tx = cmds_get_attr("neck_02.tx")
    cmds_set_attr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_02_tx)
    neck_02_ty = cmds_get_attr("neck_02.ty")
    cmds_set_attr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_02_ty)
    neck_02_tz = cmds_get_attr("neck_02.tz")
    cmds_set_attr("neck_02_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_02_tz)
    neck_02_rx = cmds_get_attr("neck_02.rx")
    cmds_set_attr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_02_rx)
    neck_02_ry = cmds_get_attr("neck_02.ry")
    cmds_set_attr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_02_ry)
    neck_02_rz = cmds_get_attr("neck_02.rz")
    cmds_set_attr("neck_02_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_02_rz)
    neck_01_tx = cmds_get_attr("neck_01.tx")
    cmds_set_attr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_01_tx)
    neck_01_ty = cmds_get_attr("neck_01.ty")
    cmds_set_attr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_01_ty)
    neck_01_tz = cmds_get_attr("neck_01.tz")
    cmds_set_attr("neck_01_translateOffsetFromNeutral_RBFdiff.input3D[1].input3Dz", neck_01_tz)
    neck_01_rx = cmds_get_attr("neck_01.rx")
    cmds_set_attr("neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dx", neck_01_rx)
    neck_01_ry = cmds_get_attr("neck_01.ry")
    cmds_set_attr("neck_01_rotateOffsetFromNeutral_RBFdiff.input3D[1].input3Dy", neck_01_ry)
    neck_01_rz = cmds_get_attr("neck_01.rz")
